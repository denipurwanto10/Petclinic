...
<div class="container">
      ...
      <h4 style="color:white; font-weight:bold;">Doctors List</h4><br> 
  ...
  <button type="button" id="tombol" class="btn btn-danger btn-sm"><img id="gambar2" class="" src="style/hidden.png"  width="20ox" height="20px"></button>
      ...
      <table id="tabel" class="table table-striped table-hover table-dark">
        <thead>
        <tr>
        <th scope="col" style="text-align:center"><p>ID</p></th>
        ...
        <td scope="row" style="text-align:center"><?php echo $i++; ?></td>
            <td scope="row" style="text-align:center"><?php echo $data['doctor_name']; ?></td>
            <td scope="row" style="text-align:center"><?php echo $data['doctor_gender']; ?></td>
            <td scope="row" style="text-align:center"><?php echo $data['doctor_address']; ?></td>
            <td scope="row" style="text-align:center"><?php echo $data['doctor_phone']; ?></td>
            <td scope="row" style="text-align:center"><img src="uploads/doctors/<?php echo $data['doctor_photo']; ?>" width="50" height="50"></td>
            <td scope="row" style="text-align:center"><a class="btn btn-warning btn-sm" href="" data-toggle="modal"
            data-target="#modal3<?php echo $data['doctor_id']; ?>"><img id="gambar2" class="rounded float-right" src="style/pencil.png"  width="20px" height="20px"></a></td><!-- untuk melihat bentuk-bentuk modal kalian bisa mengunjungi laman bootstrap dan cari modal di kotak pencariannya -->
        <!-- id setiap modal juga harus berbeda, cara membedakannya dengan menggunakan id_barang -->
        <div class="modal fade" id="modal3<?php echo $data['doctor_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="update_doctors_210017.php" enctype="multipart/form-data">
  ...
  <label for="exampleFormControlInput1">Gender</label>&nbsp;&nbsp;
    ...
    <input type="radio"  name="doctor_gender" value="Male"  <?php echo ($data['doctor_gender']=='Male')?'checked':'';?> aria-label="Radio button for following text input">&nbsp; Male
    </div>
    <div class="input-group-text">
    <input type="radio" name="doctor_gender" value="Female"  <?php echo ($data['doctor_gender']=='Female')?'checked':'';?> aria-label="Radio button for following text input">&nbsp; Female
    </div>
  </div>
</div>
<div class="form-group">
                                <label for="exampleFormControlInput1">Address</label>
                                <textarea class="form-control" name="doctor_address"><?php echo $data['doctor_address']; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Phone</label>
                                <input type="text" class="form-control" name="doctor_phone" value="<?php echo $data['doctor_phone']; ?>">
                            </div>
                            <div class="form-group">
                            <img src="uploads/doctors/<?php echo $data['doctor_photo']; ?>" width="100" height="100">
                            </div>
                            <div class="form-group">
                            <div class="input-group">
  <div class="input-group-prepend">
  ...
  <div class="custom-file">
    ...
    <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                    ...
                    <a href="read_doctors_210017.php" class="button btn btn-primary">Cancel</a>
                    <input  type="hidden" name="doctor_photo" value="<?=$data['doctor_photo']?>"></input>
        ...
        </div> <td scope="row" style="text-align:center"><a class="btn btn-danger btn-sm" href="delete_doctors_210017.php?id=<?php echo $data['doctor_id']?>" onclick="return confirm('Are you sure?')"><img id="gambar2" class="rounded float-right" src="style/trash.png"  width="20px" height="20px"></a></td>
        ...
        <div class="modal fade" id="modal1" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add New Doctors</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    data-data tersebut ditampilkan sama seperti menampilkan data pada tabel. -->
                    <div class="modal-body">
                        <form method="post" action="create_doctors_210017.php">
                        <div class="form-group">
                                <label for="exampleFormControlInput1">Name</label>
  ...
  <label for="exampleFormControlInput1">Gender</label>&nbsp;&nbsp;
    <div class="input-group-text">
    <input type="radio"  name="doctor_gender" value="Male" aria-label="Radio button for following text input">&nbsp; Male
    </div>
    <div class="input-group-text">
    <input type="radio" name="doctor_gender" value="Female" aria-label="Radio button for following text input">&nbsp; Female
    </div>
  </div>
</div>
<div class="form-group">
